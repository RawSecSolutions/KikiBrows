 ...
 */
function simularPagoExitoso(cursoId, metodoPago = 'GETNET') {
 ...
 * @param {string} metodoPago - Método de pago usado
 */
function simularPagoRechazado(cursoId, metodoPago = 'GETNET') {
    if (typeof CursosData !== 'undefined' && CursosData.init) {
        CursosData.init();
    }
...
console.log('%csimularPagoExitoso(1, "GETNET")', 'font-style: italic; color: #666;');
console.log('%csimularPagoRechazado(1, "GETNET")', 'font-style: italic; color: #666;');
