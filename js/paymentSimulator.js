 ...
 */
function simularPagoExitoso(cursoId, metodoPago = 'BANCHILE') {
 ...
 * @param {string} metodoPago - Método de pago usado
 */
function simularPagoRechazado(cursoId, metodoPago = 'BANCHILE') {
    if (typeof CursosData !== 'undefined' && CursosData.init) {
        CursosData.init();
    }
...
console.log('%csimularPagoExitoso(1, "BANCHILE")', 'font-style: italic; color: #666;');
console.log('%csimularPagoRechazado(1, "BANCHILE")', 'font-style: italic; color: #666;');
