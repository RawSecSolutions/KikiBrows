...
\begin{itemize}
  ...
  \item \textbf{Renovaci\'on del dominio en Cloudflare:} el dominio de la
        ...
        inaccesible el sitio. \textbf{La renovaci\'on es responsabilidad de
        KikiBrows SpA} y debe gestionarse directamente en Cloudflare con
        la cuenta del titular del dominio.
