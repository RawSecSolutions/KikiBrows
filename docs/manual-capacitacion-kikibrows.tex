...
% Árbol de navegación con forest
\usepackage{forest}
...
\vspace*{5mm}
\begin{center}
{\large\bfseries\color{mainblack} \'Arbol de Navegaci\'on --- Plataforma KikiBrows}\\[10pt]
{\small\color{midgray}
  \textcolor{checkgreen}{\rule{8mm}{4pt}}~P\'ublico\quad
  \textcolor{blue!60!black}{\rule{8mm}{4pt}}~Portal Alumna\quad
...
\forestset{
  nav/.style={
    ...
    text centered,
    edge={darkgray, thick},
    l sep=12mm, s sep=3mm,
  },
  public/.style={nav, fill=navpublic, draw=checkgreen!70!black},
  alumna/.style={nav, fill=navalumna, draw=blue!50!black},
  admin/.style={nav, fill=navadmin, draw=gold!80!black},
  root/.style={nav, fill=navroot, text=white, draw=navroot, text width=2.2cm},
  branch/.style={nav, text width=2.4cm, minimum height=1cm},
  leaf/.style={nav, text width=2.8cm, font=\footnotesize},
}

\begin{forest}
  for tree={grow=east, anchor=west, child anchor=west, parent anchor=east},
  [KikiBrows, root
    [Acceso\\P\'ublico, branch, public
      [Inicio\\ {\footnotesize\color{midgray}(Landing Page)}, leaf, public]
      [Vista previa\\de curso, leaf, public]
      [Iniciar sesi\'on, leaf, public]
      [Registrarse, leaf, public]
      [Recuperar\\contrase\~na, leaf, public]
    ]
    [Portal\\Alumna, branch, alumna
      [Mis Cursos\\ {\footnotesize\color{midgray}(Dashboard)}, leaf, alumna]
      [Clase / Reproductor, leaf, alumna,
        [Video, leaf, alumna]
        [Texto / PDF, leaf, alumna]
        [Quiz, leaf, alumna]
        [Tarea\\ {\footnotesize\color{midgray}(Entrega)}, leaf, alumna]
      ]
      [Historial\\de Compras, leaf, alumna]
      [Mis Certificados, leaf, alumna]
      [Consultas\\en Vivo, leaf, alumna]
      [Mi Cuenta, leaf, alumna]
      [Confirmaci\'on\\de Pago, leaf, alumna]
    ]
    [Panel\\Administradora, branch, admin
      [Dashboard, leaf, admin]
      [Gesti\'on de Cursos, leaf, admin,
        [Lista de Cursos, leaf, admin]
        [Crear / Editar\\Curso, leaf, admin]
        [Gestor de\\M\'odulos y Clases, leaf, admin]
        [Previsualizar\\Curso, leaf, admin]
      ]
      [Gesti\'on de\\Usuarias, leaf, admin]
      [Transacciones, leaf, admin]
      [Consultas en Vivo\\ {\footnotesize\color{midgray}(Admin)}, leaf, admin]
      [Revisi\'on y\\Feedback, leaf, admin]
      [Mi Perfil, leaf, admin]
    ]
  ]
\end{forest}
\end{center}
...
\textbf{Video} &
  Sube un archivo de video (MP4, WEBM, MOV, HEVC o MKV; m\'aximo 500\,MB).
...
\begin{enumerate}
  ...
  \item Haz clic en \textbf{Seleccionar archivo} y elige tu video (MP4, WEBM, MOV;
        m\'ax.\ 500\,MB) o imagen (PNG, JPG, WEBP; m\'ax.\ 2\,MB).
...
El video tard\'o mucho en subir. &
  ...
  Los videos de hasta 500\,MB pueden tardar varios minutos. \\
